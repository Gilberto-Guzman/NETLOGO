...
to setup
  ca                                   ;; clear-all
  set-default-shape coches "car"       ;; La raza de los coches tendrá forma de coche (car) por defecto
...
to go
  ...
  [
    ...
    tick                                      ;; Incrementamos el contador del numero de iteraciones
  ]
end
...
to grafica
  ...
  plot distancia_coche_1                      ;; Dibujamos la distancia recorrida por el coche_1 en la iteración actual
  set-current-plot-pen "coche2"               ;; Seleccionamos el lapiz "coche_2"
...
"coche1" 1.0 0 -10899396 true "" ""
"coche2" 1.0 0 -955883 true "" ""
