...
turtles-own [edad]     ;; Añadimos la propiedad 'edad' al conjunto de propiedades de las tortugas
to comenzar
  crt 2 [set shape "turtle" set size 1 set xcor random-pxcor set ycor random-pycor set color red set edad 7]
  crt 2 [set shape "turtle" set size 2 set xcor random-pxcor set ycor random-pycor set color blue set edad 10]
  crt 2 [set shape "turtle" set size 3 set xcor random-pxcor set ycor random-pycor set color white set edad 5]
