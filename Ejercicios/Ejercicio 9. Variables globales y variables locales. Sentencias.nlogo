...
globals [n]   ;; Declaracion de la variable global n (número de lados del polígono)
...
to comenzar
 ...
 ;; Asignamos un valor a n en función del número de lados del polígono elegido.
  ...
  ;; Definimos el ángulo inferior del polígono
...
figura
figura
"triángulo" "cuadrado" "pentágono" "hexágono" "recta" "12 lados"
3
